...
export function generateSculpturePiece(): Piece {
  ...
  const outer = polarPolygonPath(118, 75, 6 + Math.floor(Math.random() * 4), 42, 78);
  const withHole = Math.random() < 0.35;
  const path = withHole
    ? `${outer} ${polarPolygonPath(124, 76, 5, 12, 22)}`
    : outer;
    ...
    case "scoop":
      return (
        <ShapeSvg viewBox="0 0 240 130" fill={fill} className={className} bites={bites}>
          <path d="M4 8h176l40 22v26H128L72 90H10L4 8Z" />
        </ShapeSvg>
      );
    case "chevron":
      return (
    ...
    case "notch":
      return (
        <ShapeSvg viewBox="0 0 230 120" fill={fill} className={className} bites={bites}>
          <path d="M8 12h204v36H118L48 82v26h174v12H8V12Z" />
        </ShapeSvg>
      );
    case "wrap":
      return (
    ...
    case "petal":
      return (
        <ShapeSvg viewBox="0 0 200 120" fill={fill} className={className} bites={bites}>
          <path d="M12 60 48 16 188 60 48 104Z" />
        </ShapeSvg>
      );
    case "fan":
      return (
    ...
    case "arch":
      return (
        <ShapeSvg viewBox="0 0 180 150" fill={fill} className={className} bites={bites}>
          <path
            fillRule="evenodd"
            d="M10 142V74A80 80 0 0 1 170 74v68h-40V80A40 40 0 0 0 50 80v62H10Z"
          />
        </ShapeSvg>
      );
    case "custom":
